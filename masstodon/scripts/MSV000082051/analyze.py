...
with open("/Users/matteo/Projects/masstodon/data/MSV000082051/res/fit_stats.json", "r") as f:
    etd = json.load(f)
...
intensities.to_csv('/Users/matteo/Projects/masstodon/data/MSV000082051/res/intensities.csv', index=False)

etd = pd.DataFrame(etd)
etd.to_csv('/Users/matteo/Projects/masstodon/data/MSV000082051/res/ETD_fit_stats.csv')
...
our_esitmates.to_csv("/Users/matteo/Projects/masstodon/data/MSV000082051/res/estimates.csv", index=False)
